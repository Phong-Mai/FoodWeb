...
import { getTotals, selectCartTotalQuantity } from '../features/cart/cartSlice'
    ...
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
      <div className='flex items-center'>
        ...
        <div className=' hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
            ...
            <p className='p-2 font-bold'>Delevery</p>
        </div>
      </div>
      ...
      <button onClick={()=>setIsShowCart(!isShowCart)} className=' bg-orange-700 text-white flex    items-center py-2 rounded-full'>
        <span className=' bg-amber-100 rounded-full text-lime-700 mr-2 p-1'>{cartTotalQuantity}</span>
