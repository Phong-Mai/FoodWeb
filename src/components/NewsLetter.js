    ...
    <div className='max-w-full m-auto text-white px-4 bg-[#24262b]'>
        <div className='mx-auto grid lg:grid-cols-3'>
            <div className='lg:col-span-2 my-4'>
                <h1>Nees advice on how improve your flow?</h1>
            ...
            <div className='my-4'>
                ...
                <p>we are concerned abount the security of your data, Read{""}
                <span className='text-[#00df9a]'>Privacy Policy</span>
                <p>&copy; Coppyright Phong Mai  Email: <span className='text-[#00df9a]'>phongmhp@gmail.com</span></p>
                </p>
            </div>
